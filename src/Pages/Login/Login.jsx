                    ...
                    <div className="card md:w-1/2 max-w-sm shadow-2xl bg-base-100 pb-5">
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <input className="btn bg-pink-900 text-white " type="submit" value="Login" />
                            </div>
                        </form>
                        <p className='my-4 text-center'>Don't have an account? <Link className='text-pink-400 font-bold' to="/register">Sign Up</Link> </p>
